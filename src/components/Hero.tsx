        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Ihr zuverlässiger Partner für hochwertige Fenster & Türen in Warendorf und Osnabrück
            </h1>
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-8 max-w-2xl">
              Präzise Montage, persönliche Beratung und langlebige Systeme für Privatkunden, Bauträger und öffentliche Auftraggeber im Münsterland und Tecklenburger Land.
            </p>

            {/* Dezent, aber etwas stärker betont – immer noch kein Button */}
          ...
          <div className="hidden lg:block rounded-2xl overflow-hidden shadow-2xl">
            <Image
              src="/Hero.jpg"
              alt="Gebrüder Müller Fenster GmbH – Professionelle Montage moderner Fenster und Türen mit viel Tageslicht in Warendorf und Osnabrück"
              width={800}
              height={600}
